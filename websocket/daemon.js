...
var wss_receiver = new WebSocketServer({port: config.get_port, host: config.get_host});
var wss_sender = new WebSocketServer({port: config.post_port, host: config.post_host});
